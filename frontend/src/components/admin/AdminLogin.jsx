    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center bg-black px-6 overflow-hidden">
            <div style={{
                position: "absolute",
                inset: 0,
                background: "radial-gradient(ellipse 60% 50% at 50% 40%, rgba(34,197,94,0.07) 0%, transparent 70%)",
                pointerEvents: "none",
            }} />
            ...
            >
                ...
                <div className="mb-10 text-center" style={fadeUp(0.1)}>
                    <a href="/" className="inline-block mb-6 text-white/20 text-xs uppercase tracking-widest hover:text-white/40 transition-colors">
                        ← Back to site
                    </a>
                    <div className="mb-2 font-serif text-3xl font-black text-white">
                ...
                >
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                        ...
                        <button
                            ...
                            style={{
                                width: "100%",
                                background: loading ? "rgba(34,197,94,0.4)" : "rgb(21,128,61)",
                                border: "none",
                                borderRadius: "6px",
                                padding: "12px",
                                color: "white",
                ...
                <p className="mt-6 text-center text-[10px] text-white/15" style={fadeUp(0.35)}>
